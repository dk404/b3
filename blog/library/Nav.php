...
class Nav{
    ...
    public function get_nav($array)
    {
        ...
        */    
         ...
         //формируем стэк
            if(!$pervpage && !$nextpage) { $arr["stack"] = false; return $arr; exit(); }
...
//
//    public function get_num($all_posts = 1, $page = 1, $limit = 25)
//    {
//        $arr = array("all" => $all_posts);
//
//		if($page <= 1 )
//        {
//           $arr["start"] = $all_posts;
...
//        else
//        {
//           $arr["start"] = $all_posts - ($page * $limit);
//
//               $visitors_num  = $all_posts + $limit;
//               $visitors_sum  = $limit * $page;
//               $arr["start"]  = $visitors_num - $visitors_sum;
//        }
//
//        return $arr;
//
